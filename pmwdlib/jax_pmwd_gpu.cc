...
pybind11::dict Registrations() {
  ...
  dict["gpu_sort_keys_f32"] = encapsulate_function(sort_keys_f32);
  dict["gpu_sort_keys_f64"] = encapsulate_function(sort_keys_f64);
...
PYBIND11_MODULE(_jaxpmwd, m) {
  ...
  m.def("build_pmwd_descriptor_f32",
      [](int64_t n_particle, float ptcl_spacing, float cell_size,
         ...
         int16_t stride_1, int16_t stride_2, int16_t stride_3, uint32_t n_batch=1)
      {
          size_t tmp_space_size = 0;
          int64_t workspace_size = get_workspace_size(n_particle, stride_1, stride_2, stride_3, tmp_space_size);
          return std::pair<int64_t, pybind11::bytes>(workspace_size, build_descriptor<float>(n_particle, ptcl_spacing, cell_size, offset_1, offset_2, offset_3, ptcl_grid_1, ptcl_grid_2, ptcl_grid_3, stride_1, stride_2, stride_3, tmp_space_size, n_batch));
      });
  ...
  m.def("build_pmwd_descriptor_f64",
         ...
         int16_t stride_1, int16_t stride_2, int16_t stride_3, uint32_t n_batch=1)
      {
          size_t tmp_space_size = 0;
          int64_t workspace_size = get_workspace_size(n_particle, stride_1, stride_2, stride_3, tmp_space_size);
          return std::pair<int64_t, pybind11::bytes>(workspace_size, build_descriptor<double>(n_particle, ptcl_spacing, cell_size, offset_1, offset_2, offset_3, ptcl_grid_1, ptcl_grid_2, ptcl_grid_3, stride_1, stride_2, stride_3, tmp_space_size, n_batch));
      });
  ...
  m.def("build_sort_keys_descriptor_f32",
      ...
      {
          size_t tmp_space_size = 0;
          int64_t workspace_size = get_sort_keys_workspace_size<float>(n_keys, tmp_space_size);
  ...
  m.def("build_sort_keys_descriptor_f64",
      ...
      {
          size_t tmp_space_size = 0;
          int64_t workspace_size = get_sort_keys_workspace_size<double>(n_keys, tmp_space_size);
          return std::pair<int64_t, pybind11::bytes>(workspace_size, build_sort_keys_descriptor(n_keys, tmp_space_size));
      });
  ...
  m.def("build_sort_keys_descriptor_i32",
      ...
      {
          size_t tmp_space_size = 0;
          int64_t workspace_size = get_sort_keys_workspace_size<int32_t>(n_keys, tmp_space_size);
          return std::pair<int64_t, pybind11::bytes>(workspace_size, build_sort_keys_descriptor(n_keys, tmp_space_size));
      });
  ...
  m.def("build_enmesh_descriptor_f32",
      [](int64_t n_particle, float ptcl_spacing, float cell_size,
         float offset_1, float offset_2, float offset_3, int16_t ptcl_grid_1, int16_t ptcl_grid_2, int16_t ptcl_grid_3,
         int16_t stride_1, int16_t stride_2, int16_t stride_3)
      {
          size_t tmp_space_size = 0;
          int64_t workspace_size = get_enmesh_workspace_size(n_particle, stride_1, stride_2, stride_3, tmp_space_size);
  ...
  m.def("build_enmesh_descriptor_f64",
      [](int64_t n_particle, double ptcl_spacing, double cell_size,
         double offset_1, double offset_2, double offset_3, int16_t ptcl_grid_1, int16_t ptcl_grid_2, int16_t ptcl_grid_3,
         int16_t stride_1, int16_t stride_2, int16_t stride_3)
      {
