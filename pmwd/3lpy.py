...
class LPT3(object) :
    ...
    def D(z) :
        ...
        return a * hyp2f1(1, 1. / 3., 11. / 6., -aa3)
    ...
    def get3LPTPotentials(self, delta, z):
        ...
        # 2LPT
        phi2 = self.convolveHessian3DSum([phi_1, phi_1, phi_1], [[0, 0], [1, 1], [2, 2]])
        phi2 += self.convolveHessian3D([phi_1, phi_1], [[1, 1], [2, 2]])
        for i in range(3) :
            j = (i + 1) % 3
            phi2 -= self.convolveHessian3D([phi_1, phi_1], [[i, j], [i, j]])
