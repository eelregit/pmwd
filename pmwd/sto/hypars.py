...
def get_optimizer(lr):
    return optax.adam(lr, b1=0.7)
    # return optax.adamw(lr, b1=0.9, weight_decay=0.0001)

def lr_scheduler(lr, skd_state, loss, patience=20, factor=0.5, threshold=5e-4, lr_min=1e-5):
...
so_nodes = [[2*n, n, n//2, 1] for n in n_input]
