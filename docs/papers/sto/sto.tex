...
\begin{align}
  ...
  + \frac{\p\cJ}{\p\hat\vx}\frac{\p\hat\vx}{\p\vx_{i-1}} \,, \nonumber\\
                    \vpi_{i-1} :\:\!\!\!&= \vpi_{i-1}
  + \frac{\p\cJ}{\p\hat\vp}\frac{\p\hat\vp}{\p\vp_{i-1}} \,,
\end{align}
where $(\vxi, \vpi)$ are the adjoint variables of $(\vx, \vp)$, and
${\p\hat\vz}/{\p\vz_i}$ is zero except for the relevant $\vz_{k-1}$ and $\vz_k$.
Similarly we have in the initial conditions of the adjoint equations
\begin{align}
  \vxi_n &= \frac{\p\cJ}{\p\hat\vx}\frac{\p\hat\vx}{\p\vx_n} \,, \nonumber\\
  \vpi_n &= \frac{\p\cJ}{\p\hat\vp}\frac{\p\hat\vp}{\p\vp_n} \,.
\end{align}
