...
\YL{TODO: Even though the log should be enough for adaptive optimizer
and fixed sim config, this may create problem when training on all
config at the same time. And careful normalization inside the log should
be added. Same for the Eulerian losses below.}
