...
\vspace{1em}
\section{Tests on the Gradients of NN Parameters}
...
implementation of the observation inside the adjoint method of the $N$-body time
integration.
...
\begin{figure*}
  ...
  \caption{\YZ{TODO make this figure better}.
  A comparison of adjoint gradients of all parameters in the $f$ and $g$ NNs to
  those by AD.
