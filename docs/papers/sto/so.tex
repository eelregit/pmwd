...
The 512 training data samples are uniformly distributed to the processes, with
...
\begin{itemize}
  ...
  \item Optimization: learning rate scheduler, weight decay and dropout rate etc
