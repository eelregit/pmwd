...
For both the $f$ and $g$ spatial optimization NNs (SONNs), we adopt
multilayer perceptron (MLP, i.e. fully connected) structures to learn
...
In \autoref{fig:tfcc}, we show the results of $T$ and $r$ for both
