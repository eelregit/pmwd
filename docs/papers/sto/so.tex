...
\vspace{1em}
\subsection{Target Data and Configurations}
...
The training on all snapshots of a single Sobol configuration is performed on a
single GPU device.
In each training step, the loss and gradients are collected and averaged across
devices.
...
\begin{itemize}
  ...
  \item Optimization: learning rate, weight decay and dropout rate etc
\end{itemize}
}
