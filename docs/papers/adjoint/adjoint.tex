...
\title{\large Differentiable Cosmological Simulation with Adjoint Method
\vspace{0.3em}}
...
\affiliation{Department of Mathematics and Theory, Peng Cheng
Laboratory, Shenzhen, Guangdong 518066, China}
\affiliation{Department of Physics, New York University, New York, New
York 10003, USA}
...
$|\vnabla \cdot \vs|$, linear approximation of the density fluctuation,
...
\end{equation}
%
And in Fourier space, $- \vnabla \varphi(\vx)$ is just $- i \vk
\varphi(\vk)$, each component of which can be transformed back and
combined into the force field.
...
\caption{Weak scaling of \pmwd. Both the 2LPT and $N$-body components
