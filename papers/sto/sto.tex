...
\title{\large Spatiotemporal Optimization of Cosmological Particle-Mesh
Simulation by Neural, Tree, and Symbolic Regressions
\vspace{0.3em}}
...
\shorttitle{Spatiotemporally Optimized Simulation}
...
We optimize integration time steps with first neural networks and then
symbolic regression, taking dimensional analysis in consideration.
