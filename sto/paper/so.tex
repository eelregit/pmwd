...
\end{align}
where $i=0, \cdots, n-1$, and the observable is initialized with zero
values and the addition of observing the initial state
\begin{equation}
\vo_0 = \bm{0} + \vO_0(\vz_0, \vtheta).
\label{obsvbl_init}
\end{equation}
...
The initial condition of the observable \eqref{obsvbl_init} gives
\begin{equation}
...
+ \sum_{i=1}^{n} \vlambda_{i}\cdot\frac{\p\vI_{i-1}}{\p\vtheta}
+ \sum_{i=0}^{n} \vmu_{i}\cdot\frac{\p\vO_{i}}{\p\vtheta}.
\end{align}
