...
loop.
The tests run simulations of $128^3$ particles, with a $128^3$ mesh and
15 time steps.
The size and time steps of the tests are mainly limited by the memory
cost of the AD.
The objective loss function consists of snapshots at $a=(0.6, 0.8, 1)$.
...
particles' state of $N$-body, i.e. $\vxi_0$ and $\vpi_0$.
