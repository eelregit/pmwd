...
This is achieved by initializing the last layer's weights to zero and its bias
to one, while using standard He initialization for the hidden layers.
...
We initialize the parameters of NNs such that the initial output is exactly
unity, corresponding to the original PM simulation without spatial
optimization.
This is achieved by setting the weights of the output layer to zero and its
bias to one, while the hidden layers use standard He initialization.
